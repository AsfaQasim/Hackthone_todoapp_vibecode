...
- [X] T002 Initialize Python project with FastAPI, OpenAI SDK, SQLAlchemy dependencies
...
- [X] T004 Setup database schema and migrations framework for Neon PostgreSQL
- [X] T005 [P] Implement authentication/authorization framework with JWT enforcement
- [X] T006 [P] Setup API routing and middleware structure ensuring stateless server operation
...
- [X] T010 Implement MCP tool framework ensuring tools receive all data via parameters
- [X] T011 Create message persistence layer for storing user/assistant messages in DB
- [X] T012 Implement user identity validation to ensure JWT user_id matches API path user_id
...
- [X] T020 [US1] Implement ConversationService in backend/src/services/conversation_service.py (depends on T015, T017, T018)
- [X] T021 [US1] Implement MCPToolService in backend/src/services/mcp_tool_service.py
- [X] T022 [US1] Implement add_task MCP tool in backend/src/tools/add_task.py
- [X] T023 [US1] Implement list_tasks MCP tool in backend/src/tools/list_tasks.py
- [X] T024 [US1] Implement complete_task MCP tool in backend/src/tools/complete_task.py
- [X] T025 [US1] Create ChatAgent in backend/src/agents/chat_agent.py
- [X] T026 [US1] Implement chat endpoint POST /api/{user_id}/chat in backend/src/api/routes/chat.py
- [X] T027 [US1] Add validation and error handling for user story 1 operations
